...
#ifdef CONFIG_LGE_PM
#define CHR_DISABLE	(0x000E)	/* battery charging disable */
#define CHR_SUSPEND	(0x000F)	/* input currnet disable */
#endif
...
#ifdef CONFIG_LGE_PM
extern int lge_charging_init(struct charger_manager *info);
#endif
