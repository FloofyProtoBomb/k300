...
#if defined(CONFIG_MACH_MT6762_MH45LM)
static const unsigned char mt6370_torch_level_CH1[MT6370_LEVEL_TORCH] = {
	0x00, 0x00, 0x01, 0x02, 0x03, 0x04, /*0x05*/0x03, 0x06, 0x07, 0x08,
	0x10, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E
};

static const unsigned char mt6370_torch_level_CH2[MT6370_LEVEL_TORCH] = {
	0x00, 0x00, 0x01, 0x02, 0x03, 0x04, /*0x05*/0x03, 0x06, 0x07, 0x08,
	0x10, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E
};
#elif defined(CONFIG_MACH_MT6762_MH55LM)  //index 6 is chnaged to 150mA, soojong.jin@lge.com
static const unsigned char mt6370_torch_level_CH1[MT6370_LEVEL_TORCH] = {
	0x00, 0x02, 0x04, 0x06, 0x08, 0x0A, 0x0A, 0x0E, 0x10, 0x12,
	0x14, 0x16, 0x18, 0x1A, 0x1C, 0x1E
};

static const unsigned char mt6370_torch_level_CH2[MT6370_LEVEL_TORCH] = {
	0x02, 0x05, 0x06, 0x08, 0x0A, 0x0C, 0x0E, 0x10, 0x12,
	0x14, 0x16, 0x18, 0x1A, 0x1C, 0x1E
};
...
//[LGE_UPDATE_S] [kyunghun.oh@lge.com] [2018-11-02] enable the setting of front flash torch level
static const unsigned char mt6370_torch_level_for_app[MT6370_LEVEL_TORCH] = {
	0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
	0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D
};
//[LGE_UPDATE_E] [kyunghun.oh@lge.com] [2018-11-02] enable the setting of front flash torch level
...
static const unsigned char mt6370_strobe_level[MT6370_LEVEL_FLASH] = {
#if defined(CONFIG_MACH_MT6762_DH5LM)
	0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C,
	0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x1C, 0x2C, 0x3C,
	0x4C, 0x4C, 0x4C, 0x4C, 0x4C, 0x4C, 0x4C, 0x4C, 0x4C, 0x4C,
	0x4C, 0x4C
#elif defined(CONFIG_MACH_MT6765_DH50LM)
	0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C,
	0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x1C, 0x2C, 0x3C,
	0x4C, 0x4C, 0x4C, 0x4C, 0x4C, 0x4C, 0x4C, 0x4C, 0x4C, 0x4C,
	0x4C, 0x4C
	...
	0x04, 0x04, 0x04, 0x0C, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04,
	0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x06, 0x08, 0x10,
	...
	0x1C, 0x1C, 0x1C, 0x1C, 0x1C, 0x1C, 0x1C, 0x2C, 0x3C, 0x4C,
...
//[LGE_UPDATE_S] [kyunghun.oh@lge.com] [2018-10-12] Split the torch level array of CH1 and CH2
    ...
    //torch is always level 6
	if (!mt6370_is_torch(level)) {
        pr_err("set CH1 torch level(IDX) = %d, value = %d\n", level, mt6370_torch_level_CH1[level]);
		flashlight_set_torch_brightness(
				flashlight_dev_ch1, mt6370_torch_level_CH1[level]);
    }
	pr_err("set CH1 strobe level(IDX) = %d, value = %d\n", level, mt6370_strobe_level[level]);
...
//[LGE_UPDATE_S] [kyunghun.oh@lge.com] [2018-10-12] Split the torch level array of CH1 and CH2
    //torch is always levle 1
	/* set brightness level */
	if (!mt6370_is_torch(level)) {
        pr_err("set CH2 torch level(IDX) = %d, value = %d\n", level, mt6370_torch_level_CH2[level]);
		flashlight_set_torch_brightness(
				flashlight_dev_ch2, mt6370_torch_level_CH2[level]);
    }
	pr_err("set CH2 strobe/torch level(IDX) = %d, value = %d\n", level, mt6370_strobe_level[level]);
	flashlight_set_strobe_brightness(
...
#ifdef CONFIG_LGE_PM
			charger_manager_enable_hz(flashlight_charger_consumer, false);
#endif
...
#ifdef CONFIG_LGE_PM
			charger_manager_enable_hz(flashlight_charger_consumer, true);
#endif
			charger_manager_enable_high_voltage_charging(
