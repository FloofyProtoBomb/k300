...
extern char rear_sensor_name[20];/*LGE_CHANGE, 2019-11-14, add the camera identifying logic , bk.bae@lge.com*/
...
static struct imgsensor_info_struct imgsensor_info = { 
	...
	.pre = {
		...
		.framelength = 1665, 			//record different mode's framelength
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =
{
	...
	.i4PosR =	{
						...
						*/
						{61,24}, {77,24}, {69,36}, {85,36},
						{61,40}, {77,40}, {69,52}, {85,52},
				},
	.i4PosL =	{
						/*
						...
						*/
						{61,28}, {77,28}, {69,32}, {85,32},
						{61,44}, {77,44}, {69,48}, {85,48},
				},
...
static kal_uint16 read_sensor_eeprom(kal_uint32 addr)
{
	...
	iReadRegI2C(pu_send_cmd, 2, (u8 *)&get_byte, 1, HI1336_QTECH_EEPROM);
...
kal_uint16 addr_data_pair_init_hi1336[] = {
	...
	0x0668, 0x4303, //blc_spare b15:8:blc nr weight threshold, b2:obp_range_scaler, b1:0:blc_dpc_mode
...
kal_uint16 addr_data_pair_preview_hi1336[] = {
	...
	0x020a, 0x067b, //0x0d03, //coarse integ time
	0x021c, 0x0008, //coarse integ time short for iHDR
	0x0206, 0x05dd, //line length pck
	0x020e, 0x0681, //0x0d00, //frame length lines
	...
	0x0b04, 0x037c, //0x037e, //isp enable
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x1018, 0x0040); //mipi_hblank_short_delay2
	...
	write_cmos_sensor(0x104c, 0x0000);
...
kal_uint16 addr_data_pair_capture_30fps_hi1336[] = {
	...
	0x0246, 0x0020, //y read dummy address
	0x020a, 0x0cfe, //0x0d03 //coarse integ time
	0x021c, 0x0008, //coarse integ time short for iHDR
	0x0206, 0x05dd, //line length pck
	0x020e, 0x0d02, //0x0d00 //frame length lines
...
kal_uint16 addr_data_pair_capture_15fps_hi1336[] = {
	...
	0x1004, 0x2bb0,
	0x103e, 0x0000, //mipi_tx_col_read_ctrl
	0x1020, 0xc10b, //0xc106, //mipi_exit_seq, tlpx
	0x1022, 0x0a31, //0x0617, //mipi_tclk_prepare, tclk_zero
	0x1024, 0x030b, //0x0306, //mipi_tclk_pre, ths_prepare
	0x1026, 0x0d0f, //0x0609, //mipi_ths_zero, ths_trail
	0x1028, 0x1a0e, //0x1207, //mipi_tclk_post, tclk_trail
	0x102a, 0x1311, //0x0a0a, //mipi_texit, tsync
	0x102c, 0x2400, //0x1600, //mipi_tpd_sync
	0x1010, 0x07d0, //mipi_vblank_delay
	0x1012, 0x017d, //0x0201, //mipi_ch0_hblank_delay
	0x1014, 0x006a, //0x00b9, //mipi_hblank_short_delay1
	0x1016, 0x006a, //0x00b9, //mipi_hblank_short_delay2
	0x1018, 0x0040, //0x00b9, //mipi_hblank_short_delay2
	0x101a, 0x006a, //0x00b9, //mipi_pd_hblank_delay
	0x1038, 0x4100, //0x4100, //mipi_virtual_channel_ctrl
	0x1042, 0x0108, //0x0108, //mipi_pd_sep_ctrl_h, mipi_pd_sep_ctrl_l
	0x1048, 0x0080, //mipi_pd_max_col_size
	0x1044, 0x0100, //mipi_pd_col_size
	0x1046, 0x0004, //mipi_pd_row_size
	0x104c, 0x0000,
	...
	0x021c, 0x0008, //coarse integ time short for iHDR
	0x0206, 0x05dd, //line length pck
	0x020e, 0x1a02, //0x0d00, //frame length lines
	0x0b12, 0x1070, //x output size
	0x0b14, 0x0c30, //y output size
	0x0204, 0x0000, //d2a_row_binning_en
	0x041c, 0x0048, //pdaf patch start x-address 
...
static void capture_setting(kal_uint16 currefps)
{
  ...
  if( currefps == 300) {
	  ...
	  write_cmos_sensor(0x041c, 0x0048); //pdaf patch start x-address 
	  write_cmos_sensor(0x041e, 0x1047); //pdaf patch end x-address 
	  write_cmos_sensor(0x0b04, 0x037c); //isp enable
	  //write_cmos_sensor(0x027e, 0x0100); //tg enable
...
// PIP
	  ...
	  write_cmos_sensor(0x1014, 0x006a); //mipi_hblank_short_delay1
	  write_cmos_sensor(0x1016, 0x006a); //mipi_hblank_short_delay2
	  write_cmos_sensor(0x1016, 0x0040);
	  write_cmos_sensor(0x101a, 0x006a); //mipi_pd_hblank_delay
	  write_cmos_sensor(0x1038, 0x4100); //mipi_virtual_channel_ctrl
	  write_cmos_sensor(0x1042, 0x1108); //mipi_pd_sep_ctrl_h, mipi_pd_sep_ctrl_l
	  write_cmos_sensor(0x1048, 0x0080); //mipi_pd_max_col_size
...
kal_uint16 addr_data_pair_hs_video_hi1336[] = {
	...
	0x0246, 0x0020, //y read dummy address
	0x020a, 0x033b, //0x0339, //coarse integ time
	0x021c, 0x0008, //coarse integ time short for iHDR
	0x0206, 0x05dd, //line length pck
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_24fps_hi1336[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
	0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1)
	0x0732, 0xe0b0, //pll_cfg_mipi_b b13-11:100_isp_div1(1/5) b10-8:000_mipi_div1(1/1) b1-0:00_mipi_div2(1/1)
	0x1118, 0x0006, //LSC r_win_y B[11]: Bit8 of y offset in start block when cropping. B[10:8] y start index of block when cropping. B[7:0] y offset in start block when cropping.
	...
	0x101a, 0x006a, //mipi_pd_hblank_delay
	0x1038, 0x4100, //mipi_virtual_channel_ctrl
	0x1042, 0x1108, //mipi_pd_sep_ctrl_h, mipi_pd_sep_ctrl_l
	0x1048, 0x0080, //mipi_pd_max_col_size
	0x1044, 0x0100, //mipi_pd_col_size
	0x1046, 0x0004, //mipi_pd_row_size
	0x104c, 0x0000,
	...
	0x0238, 0x1111, //y even/odd inc active
	0x0246, 0x0020, //y read dummy address
	0x020a, 0x103c, //coarse integ time
	0x021c, 0x0008, //coarse integ time short for iHDR
	0x0206, 0x05dd, //line length pck
	0x020e, 0x1040, //frame length lines
	0x0b12, 0x1070, //x output size
	0x0b14, 0x0c30, //y output size
	0x0204, 0x0000, //d2a_row_binning_en
	0x041c, 0x0048, //pdaf patch start x-address
...
#if MULTI_WRITE
	hi1336_table_write_cmos_sensor(
		addr_data_pair_custom1_24fps_hi1336,
		sizeof(addr_data_pair_custom1_24fps_hi1336) /
		sizeof(kal_uint16));
#endif
}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				strcpy(rear_sensor_name, "hi1336rear_lgit");/*LGE_CHANGE, 2019-11-14, add the camera identifying logic , bk.bae@lge.com*/
...
{
	LOG_DEBUG("[HI1336] preview start\n");
	spin_lock(&imgsensor_drv_lock);
...
static kal_uint32 capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
			MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	LOG_DEBUG("[HI1336] capture start\n");
	spin_lock(&imgsensor_drv_lock);
...
static kal_uint32 normal_video(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	LOG_DEBUG("[HI1336] normal_video start\n");
	spin_lock(&imgsensor_drv_lock);
...
UINT32 HI1336_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	printk("HI1336_MIPI_RAW_SensorInit.\n");
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
