...
extern char aux_sensor_name[20];/*LGE_CHANGE, 2020-02-06, add the camera identifying logic , bk.bae@lge.com*/
static struct imgsensor_info_struct imgsensor_info = {
	...
	.i2c_addr_table = {0x30, 0xff}, //{0x20, 0x5a, 0xff},
	.i2c_speed = 400,
};
...
// capture
{ 2592, 1944,	  0,	0, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944,	  0,	0, 2592, 1944},
// video
{ 2592, 1944,	  0,    0, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944,	  0,	0, 2592, 1944},
//hight speed video
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	/*****ADD I2C BUS CHECK START*****/
	I2C_bus = i2c_adapter_id(pgi2c_cfg_legacy->pinst->pi2c_client->adapter);
	pr_info("S5K5E8YX_I2CBUS = %d\n", I2C_bus);
	if (I2C_bus != S5K5E8YXFRONT_I2CBUS) {
		*sensor_id = 0xFFFFFFFF;
		pr_info("S5K5E8YX_I2CBUS:%d Check Error!\n", I2C_bus);
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	/*****ADD I2C BUS CHECK END*****/
#endif
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				strcpy(aux_sensor_name, "s5k5e8yx_sunny");/*LGE_CHANGE, 2020-02-06, add the camera identifying logic , bk.bae@lge.com*/
...
#if 0 //[LGE_CHANGE] TEMP :  fix 24fps capture setting for bokeh
...
{
    printk("S5K5E8YX_MIPI_RAW_SensorInit\n");
