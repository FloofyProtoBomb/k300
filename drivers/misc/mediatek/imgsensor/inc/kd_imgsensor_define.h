...
//////////////////// MDH50LM OTP start ////////////////////
typedef struct mdh50lm_awb_t {
	kal_uint8 data[6];
} mdh50lm_awb_t;

typedef struct mdh50lm_lsc_t {
	kal_uint8 data[221];
} mdh50lm_lsc_t;

typedef struct mdh50lm_otp_data {
	mdh50lm_awb_t awb_5100k;
	mdh50lm_lsc_t lsc_5100k_r;
	mdh50lm_lsc_t lsc_5100k_gr;
	mdh50lm_lsc_t lsc_5100k_gb;
	mdh50lm_lsc_t lsc_5100k_b;
	mdh50lm_awb_t awb_3100k;

	kal_uint8 awb_5100k_flag;
	kal_uint8 lsc_5100k_flag;
	kal_uint8 awb_3100k_flag;
} mdh50lm_otp_data_t;
...
enum OTP_FORM {
	...
	MDH50LM_LSC_5100K,
	MDH50LM_AWB_3100K,
	MDH50LM_OTP_FORM_MAX
};

enum OTP_FORM_K2H {
    MDH50LM_AWB_5100K_FLAG = 0,
    MDH50LM_LSC_5100K_FLAG,
    MDH50LM_AWB_3100K_FLAG,

    MDH50LM_AWB_5100K_DATA,
    MDH50LM_LSC_5100K_R_DATA,
    MDH50LM_LSC_5100K_GR_DATA,
    MDH50LM_LSC_5100K_GB_DATA,
    MDH50LM_LSC_5100K_B_DATA,
    MDH50LM_AWB_3100K_DATA,
};

#define MDH50LM_AWB_SIZE	6
#define MDH50LM_LSC_SIZE	221
#define MDH50LM_OTP_SIZE	sizeof(mdh50lm_otp_data_t)
//////////////////// MDH50LM OTP end ////////////////////

//////////////////// MDH5LM OTP start ////////////////////
typedef struct mdh5lm_awb_t {
	kal_uint8 data[6];
} mdh5lm_awb_t;

typedef struct mdh5lm_lsc_t {
	kal_uint8 data[221];
} mdh5lm_lsc_t;

typedef struct mdh5lm_otp_data {
	mdh5lm_awb_t awb_5100k;

	mdh5lm_awb_t awb_3100k;

	mdh5lm_lsc_t lsc_5100k_r;
	mdh5lm_lsc_t lsc_5100k_gr;
	mdh5lm_lsc_t lsc_5100k_gb;
	mdh5lm_lsc_t lsc_5100k_b;

	mdh5lm_lsc_t lsc_4000k_r;
	mdh5lm_lsc_t lsc_4000k_gr;
	mdh5lm_lsc_t lsc_4000k_gb;
	mdh5lm_lsc_t lsc_4000k_b;

	kal_uint8 awb_5100k_flag;
	kal_uint8 awb_3100k_flag;
	kal_uint8 lsc_5100k_flag;
	kal_uint8 lsc_4000k_flag;
} mdh5lm_otp_data_t;
...
enum DH5LM_OTP_FORM_K2H {
    MDH5LM_AWB_5100K_FLAG = 0,
    MDH5LM_AWB_3100K_FLAG,
    MDH5LM_LSC_5100K_FLAG,
    MDH5LM_LSC_4000K_FLAG,

    MDH5LM_AWB_5100K_DATA,

    MDH5LM_AWB_3100K_DATA,

    MDH5LM_LSC_5100K_R_DATA,
    MDH5LM_LSC_5100K_GR_DATA,
    MDH5LM_LSC_5100K_GB_DATA,
    MDH5LM_LSC_5100K_B_DATA,

    MDH5LM_LSC_4000K_R_DATA,
    MDH5LM_LSC_4000K_GR_DATA,
    MDH5LM_LSC_4000K_GB_DATA,
    MDH5LM_LSC_4000K_B_DATA,
};

#define MDH5LM_AWB_SIZE	6
#define MDH5LM_LSC_SIZE	221
#define MDH5LM_OTP_SIZE	sizeof(mdh5lm_otp_data_t)
//////////////////// MDH5LM OTP end ////////////////////
