...
#if 0
#define GPIO_IO_LDO_EN             (GPIO165 | 0x80000000)
...
static struct LCM_setting_table_V3 lcm_initial_command[] = {
  ...
  // DISPCTL1
  {0x39, 0xB3, 8,   {0x02, 0x03, 0x05, 0x00, 0x72, 0x00, 0x02, 0x12}},
  // DISPCTL2
  {0x39, 0xB4, 35,  {0x12, 0xC7, 0x78, 0x06, 0x06, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAC,
                     0x96, 0x00, 0x00, 0x00, 0x03, 0x03, 0x01, 0x34, 0x01, 0x02, 0x03, 0x01, 0x34, 0x01, 0x0F, 0x03,
                     0x01, 0x34, 0x01}},
  // DISPCTL3
  {0x39, 0xB5, 25,  {0x02, 0x0D, 0x04, 0x01, 0x13, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x05, 0x44, 0xEE, 0x88,
                     0xC6, 0xE5, 0x14, 0x88, 0xC6, 0xE5, 0x14, 0x22, 0x00}},
  // DISPCTL4
  {0x39, 0xB6, 7,   {0x00, 0x38, 0x14, 0x08, 0x04, 0x10, 0x08}},
  // PANELSET
  {0x39, 0xB7, 4,   {0x00, 0x50, 0x66, 0x02}},
  // TCHTIMCTL
  {0x39, 0xB8, 31,  {0x07, 0x14, 0xF4, 0x40, 0x22, 0x00, 0x00, 0x00, 0x00, 0x50, 0x01, 0x01, 0x01, 0x46, 0xCC, 0x44,
                     0xB4, 0x00, 0x00, 0x00, 0x00, 0x10, 0x02, 0x04, 0x01, 0x0D, 0x50, 0x58, 0x61, 0x31, 0x6E}},
  // TCHSRCSET
  {0x39, 0xB9, 5,   {0x32, 0x32, 0x2A, 0x30, 0x03}},
  // PWM
  {0x39, 0xFA, 14,  {0xFF, 0x22, 0x22, 0x22, 0x20, 0x00, 0x70, 0x84, 0x02, 0x60, 0x09, 0x06, 0x42, 0x1C}},
  // NOTCH UP RADIUS
  ...
  // PWRCTL4
  {0x39, 0xC4, 3,   {0xA2, 0x9A, 0x9A}},
  // PWRCTL5
  {0x39, 0xC5, 5,   {0x94, 0x04, 0x6C, 0x2E, 0x2E}},
  // VCOMSET
  {0x39, 0xC6, 2,   {0x19, 0x01}},
  // PSEQOPT
  {0x39, 0xCA, 22,  {0x15, 0x1D, 0x00, 0xB0, 0x5A, 0xF5, 0x7F, 0x3F, 0x3F, 0xD6, 0x3F, 0xD6, 0x3F, 0xD6, 0x3F, 0xD6,
                     0x7F, 0xD6, 0x7F, 0xD6, 0x3F, 0xC2}},
  // APODCFG
  {0x39, 0xCB, 5,   {0x3F, 0x7B, 0xF0, 0x30, 0x37}},
  // LFDCTL
  {0x39, 0xCC, 6,   {0x73, 0x90, 0x55, 0x3D, 0x3D, 0x11}},
  // TTFTSET
  {0x39, 0xCD, 8,   {0x14, 0x11, 0x40, 0x92, 0x11, 0xFF, 0xB0, 0x60}},
  // PWRCTL_TOUCH
  {0x39, 0xCE, 6,   {0x29, 0x4A, 0x1A, 0x1A, 0x00, 0xAB}},
  // GAMMA0
  {0x39, 0xD0, 126, {0x01, 0x01, 0x02, 0x02, 0x16, 0x16, 0x28, 0x28, 0x35, 0x35, 0x3F, 0x3F, 0x5B, 0x5B, 0x77, 0x77,
                     0x89, 0x89, 0x99, 0x99, 0x69, 0x69, 0xC8, 0xC8, 0xB7, 0xB7, 0xA1, 0xA1, 0x7F, 0x7F, 0x59, 0x59,
                     0x4B, 0x4B, 0x39, 0x39, 0x21, 0x21, 0x12, 0x12, 0x00, 0x00, 0x01, 0x01, 0x02, 0x02, 0x16, 0x16,
                     0x28, 0x28, 0x35, 0x35, 0x3F, 0x3F, 0x5D, 0x5D, 0x76, 0x76, 0x89, 0x89, 0x99, 0x99, 0x68, 0x68,
                     0xC8, 0xC8, 0xB7, 0xB7, 0xA1, 0xA1, 0x7F, 0x7F, 0x5B, 0x5B, 0x4D, 0x4D, 0x3C, 0x3C, 0x24, 0x24,
                     0x14, 0x14, 0x00, 0x00, 0x01, 0x01, 0x02, 0x02, 0x16, 0x16, 0x28, 0x28, 0x35, 0x35, 0x3F, 0x3F,
                     0x5B, 0x5B, 0x76, 0x76, 0x88, 0x88, 0x98, 0x98, 0x67, 0x67, 0xC9, 0xC9, 0xB9, 0xB9, 0xA3, 0xA3,
                     0x82, 0x82, 0x5E, 0x5E, 0x4F, 0x4F, 0x3E, 0x3E, 0x25, 0x25, 0x14, 0x14, 0x00, 0x00}},
  // LEFT GIP SET
  {0x39, 0xE5, 12,  {0x11, 0x0F, 0x0A, 0x27, 0x27, 0x0E, 0x10, 0x02, 0x06, 0x0F, 0x29, 0x28}},
  // RIGHT GIP SET
  {0x39, 0xE6, 12,  {0x12, 0x0F, 0x0A, 0x27, 0x27, 0x0E, 0x10, 0x05, 0x09, 0x0F, 0x29, 0x28}},
  // LETT MUX SET
  {0x39, 0xE7, 12,  {0x18, 0x17, 0x16, 0x15, 0x14, 0x13, 0x25, 0x25, 0x25, 0x25, 0x25, 0x25}},
  // RIGHT MUX SET
  {0x39, 0xE8, 12,  {0x1E, 0x1D, 0x1C, 0x1B, 0x1A, 0x19, 0x25, 0x25, 0x25, 0x25, 0x25, 0x25}},
  // IMAGE QUALITY TUNING SET
  {0x15, 0xF0, 1,   {0xC0}},
...
struct LCM_DRIVER sw49110_tovis_fhdplus_dsi_cmd_dh50_lcm_drv = {
  .name = "TOVIS-SW49110",
