...
int PMIC_VCDT_init_setting(void)
{
	unsigned int val = 0;

#ifdef CONFIG_MACH_MT6762_DH5LM
	val = pmic_set_register_value(PMIC_RG_VCDT_HV_EN, 1);
	val = pmic_set_register_value(PMIC_RG_VCDT_HV_VTH, 0xd); /* 7000mV */
#endif
