...
int DW9768AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
        int *pAF_Opened)
{
...
int DW9768AF_GetFileName(unsigned char *pFileName)
{
...
/*LGE_CHANGE_S, 2019-05-22, WBT issue , ssora.lee@lge.com*/
	if(FileString == NULL) {
		pFileName[0] = '\0';
		return 0;
	}
...
/*LGE_CHANGE_E, 2019-05-22, WBT issue , ssora.lee@lge.com*/
