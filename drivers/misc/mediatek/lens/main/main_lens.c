...
static struct stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	...
	{1, AFDRV_DW9768AF, DW9768AF_SetI2Cclient, DW9768AF_Ioctl,
	 DW9768AF_Release, DW9768AF_GetFileName, NULL},
	{1, AFDRV_ZC524AF, ZC524AF_SetI2Cclient, ZC524AF_Ioctl,
	 ZC524AF_Release, ZC524AF_GetFileName, NULL},
#if 0
	...
	if (Stage == 0) {
		if (regVCAMAF == NULL) {
			...
			if (node) {
				...
				#if 1 //defined(CONFIG_MACH_MT6761)
				regVCAMAF =
...
#if 0//soojong def CONFIG_MACH_MT6765
...
void AF_PowerDown(void)
{
	...
	//soojong, build error MAIN2AF_PowerDown();
}
