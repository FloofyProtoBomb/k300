...
#define DW9768AF_SetI2Cclient DW9768AF_SetI2Cclient_Main
#define DW9768AF_Ioctl DW9768AF_Ioctl_Main
#define DW9768AF_Release DW9768AF_Release_Main
#define DW9768AF_GetFileName DW9768AF_GetFileName_Main
extern int DW9768AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long DW9768AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9768AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int DW9768AF_GetFileName(unsigned char *pFileName);

#define ZC524AF_SetI2Cclient ZC524AF_SetI2Cclient_Main
#define ZC524AF_Ioctl ZC524AF_Ioctl_Main
#define ZC524AF_Release ZC524AF_Release_Main
#define ZC524AF_GetFileName ZC524AF_GetFileName_Main
extern int ZC524AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long ZC524AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int ZC524AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int ZC524AF_GetFileName(unsigned char *pFileName);
