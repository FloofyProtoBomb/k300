...
enum power_supply_property {
...
#ifdef CONFIG_LGE_PM
	/* below items are not defined in power_supply_sysfs.c */
#else /* MediatTek */
	...
	POWER_SUPPLY_PROP_TTF_CAPACITY,
	POWER_SUPPLY_PROP_TYPEC,
#endif
	...
	POWER_SUPPLY_PROP_QNS_FCC,
	POWER_SUPPLY_PROP_QNS_VFLOAT,
#endif
