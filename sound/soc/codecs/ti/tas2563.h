...
#define TAS2563_BROADCAST_ADDR  0x4c
...
//#define TAS2563_DOUBLE_RESET_PIN

#ifdef CONFIG_SND_SOC_TAS2563_LGE
#define TAS2563_CAL_STATUS_NOT_YET 0
#define TAS2563_CAL_STATUS_DONE 1
#define TAS2563_CAL_STATUS_RUNNING 2
#endif
...
#define TAS2563_REG(book, page, reg)\
...
#define TAS2563_TDMConfigurationReg0_SAMPRATE31_14_07_16kHz  (0x1 << 1)
#define TAS2563_TDMConfigurationReg0_SAMPRATE31_22_05_24kHz  (0x2 << 1)
#define TAS2563_TDMConfigurationReg0_SAMPRATE31_29_4_32kHz  (0x3 << 1)
...
#define TAS2563_NoiseGate  TAS2563_REG(0x0, 0x0, 0x3e)
#define TAS2563_IDCT_92  TAS2563_REG(0x0, 0x2, 0x5c)
#define TAS2563_IDCT_93  TAS2563_REG(0x0, 0x2, 0x5d)
#define TAS2563_IDCT_94  TAS2563_REG(0x0, 0x2, 0x5e)
#define TAS2563_IDCT_95  TAS2563_REG(0x0, 0x2, 0x5f)

#define TAS2563_IDCH_100  TAS2563_REG(0x0, 0x2, 0x64)
#define TAS2563_IDCH_101  TAS2563_REG(0x0, 0x2, 0x65)
#define TAS2563_IDCH_102  TAS2563_REG(0x0, 0x2, 0x66)
#define TAS2563_IDCH_103  TAS2563_REG(0x0, 0x2, 0x67)

#define TAS2563_DCV_PCM_12  TAS2563_REG(0x0, 0x2, 0x0c)
#define TAS2563_DCV_PCM_13  TAS2563_REG(0x0, 0x2, 0x0d)
#define TAS2563_DCV_PCM_14  TAS2563_REG(0x0, 0x2, 0x0e)
#define TAS2563_DCV_PCM_15  TAS2563_REG(0x0, 0x2, 0x0f)

/*180 shift*/
#define TAS2563_180_SHIFT  TAS2563_REG(0x0, 0x6, 0x24)
//////////////////////////////////////
...
#define	TAS2563_APP_ROM2MODE	2
#define	TAS2563_APP_TUNINGMODE	1
...
#define TAS2563_I2C_RETRY_COUNT      3
...
struct tas2563_priv {
	...
	int mnLeftCurrentConfiguration;
	int mnRightCurrentConfiguration;
	int mnBothCurrentConfiguration;
	...
	int mnPCMFormat;
	//int mnVBoostState;
	int mnVBoostLeftState;
	int mnVBoostRightState;
	...
	int mnRAddr;
	bool mbTILoadActive;
	int (*read)(struct tas2563_priv *pTAS2563, enum channel chn,
		unsigned int reg, unsigned int *pValue);
	int (*write)(struct tas2563_priv *pTAS2563, enum channel chn,
		unsigned int reg, unsigned int Value);
	int (*bulk_read)(struct tas2563_priv *pTAS2563, enum channel chn,
		unsigned int reg, unsigned char *pData, unsigned int len);
	int (*bulk_write)(struct tas2563_priv *pTAS2563, enum channel chn,
		unsigned int reg, unsigned char *pData, unsigned int len);
	int (*update_bits)(struct tas2563_priv *pTAS2563, enum channel chn,
		unsigned int reg, unsigned int mask, unsigned int value);
	void (*hw_reset)(struct tas2563_priv *pTAS2563);
	void (*clearIRQ)(struct tas2563_priv *pTAS2563);
	void (*enableIRQ)(struct tas2563_priv *pTAS2563,
		enum channel chn,  bool enable);
	...
	int (*set_calibration)(struct tas2563_priv *pTAS2563,
		enum channel chl, int calibration);
	int (*set_config)(struct tas2563_priv *pTAS2563,
		enum channel chl, int config);
